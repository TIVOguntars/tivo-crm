...
BEGIN
  ...
  -- The on_auth_user_created trigger may have already inserted a stub profile row.
  -- Upsert to promote that stub into the full profile in the same transaction.

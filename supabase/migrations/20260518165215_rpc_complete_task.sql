-- Versioned record of crm.rpc_complete_task already applied to production DB.
-- No data changes, no triggers, no cron, no workflow advancement,
-- no automatic next-task generation. Function definition + grants only.

-- Fix: crm.audit_events requires action_type, source_type (NOT NULL).
-- Recreate the 6 affected functions with corrected INSERT column lists.
-- Only audit_events INSERTs change; business logic preserved verbatim.
...
BEGIN
  ...
  VALUES ('lead', p_lead_id, 'email_plan_generated', 'automation', 'email_plan_generated', 'email_plan_generated',
...
BEGIN
  ...
  INSERT INTO crm.audit_events(entity_type, entity_id, action_type, source_type, event_key, event_name, metadata)
  VALUES ('lead', p_lead_id, 'email_plan_paused', 'automation', 'email_plan_paused', 'email_plan_paused',
...
BEGIN
  ...
  INSERT INTO crm.audit_events(entity_type, entity_id, action_type, source_type, event_key, event_name, metadata)
  SELECT 'communication_queue', p_id, 'queue_item_cancelled', 'automation', 'queue_item_cancelled', 'queue_item_cancelled',
         jsonb_build_object('reason', p_reason);
END $function$;
...
BEGIN
  ...
  INSERT INTO crm.audit_events(entity_type, entity_id, action_type, source_type, event_key, event_name, metadata)
  SELECT 'communication_queue', p_id, 'queue_item_rescheduled', 'automation', 'queue_item_rescheduled', 'queue_item_rescheduled',
...
BEGIN
  ...
  INSERT INTO crm.audit_events(entity_type, entity_id, action_type, source_type, event_key, event_name, metadata)
  VALUES ('communication_queue', v_row.id, 'email_dispatched', 'automation', 'email_dispatched', 'email_dispatched',
          jsonb_build_object('pg_net_request_id', v_req_id,
...
BEGIN
  ...
  LOOP
    ...
    IF v_resp.status_code BETWEEN 200 AND 299 THEN
      ...
      INSERT INTO crm.audit_events(entity_type, entity_id, action_type, source_type, event_key, event_name, metadata)
      VALUES ('communication_queue', v_row.id, 'email_sent', 'automation', 'email_sent', 'email_sent',
    ...
    ELSE
      IF COALESCE(v_row.attempt_count,0) >= COALESCE(v_row.max_attempts,3) THEN
        ...
        INSERT INTO crm.audit_events(entity_type, entity_id, action_type, source_type, event_key, event_name, metadata)
        VALUES ('communication_queue', v_row.id, 'email_failed_terminal', 'automation', 'email_failed_terminal', 'email_failed_terminal',
                jsonb_build_object('http_status', v_resp.status_code,
                                   'error_msg', v_resp.error_msg));
      ELSE
        UPDATE crm.communication_queue
        ...
        INSERT INTO crm.audit_events(entity_type, entity_id, action_type, source_type, event_key, event_name, metadata)
        VALUES ('communication_queue', v_row.id, 'email_failed_retry', 'automation', 'email_failed_retry', 'email_failed_retry',
                jsonb_build_object('http_status', v_resp.status_code,
